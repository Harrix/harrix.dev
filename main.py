...
def main():
    # markdown_filename = 'C:/Harrix/GitHub/harrix.dev-articles-2019/2019-07-23-add-2-num-android/2019-07-23-add-2-num-android.md'
    # output_path = '../dist'
    # hsg.MarkdownToHtml(markdown_filename, output_path).start()

    markdown_path = "C:/Harrix/GitHub/harrix.dev-articles-2017/"
    # output_path = './dist'
